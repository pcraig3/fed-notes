...
This is a more localized point, but in many large organizations, IT roles tend to stop hands-on development work as they become more senior. Enterprise orgs usually have [lots of internal oversight committees](https://federal-field-notes.ca/articles/2022-03-22-move-fast-stay-safe/#empowered-teams-vs-oversight-committees), which, in practice, translates into lots of time spent creating diagrams and attending meetings. Senior folks focus on these more ‘strategic’ aspects — planning, diagramming, shepherding products through committees — while actually coding the application is seen as more appropriate for junior roles. Over time, you can end up with senior IT staff that have a lot of organizational context and are experts in their area of focus, but who haven’t written code for a decade or more.

This wouldn’t pose too much of a problem if the technology landscape had remained relatively stable, but the widespread growth of cloud-based development over the last several years represents paradigmatic shift in how modern applications are developed.

All of today’s mega-expensive IT projects are being planned for the cloud (or as “cloud hybrids”), and cloud technologies are mostly too recent for many senior IT folks to have had hands-on experience with it. So you can end up with situations in which strategic IT groups unfamiliar with modern cloud-based development are responsible for planning hugely expensive and complex cloud-based platforms that will have seismic ripple effects. What you get from these teams is a lot (**a lot**) of diagrams, requirements documents, and PowerPoints (often based on consultants’ recommendations), which, problematically, [mask the level of organizational uncertainty](https://federal-field-notes.ca/articles/2022-03-22-move-fast-stay-safe/#the-docs-blocker), creating more risk down the road.

Once again, it’s basically the reverse of what you would want. Nothing can be built without there first being a plan, so you end up having to create a plan to build something even before you really understand the thing you’re building.
...
Whenever you make a change to a platform, the knock-on effects are much larger than they are for an individual service. This means that you probably want a lot of domain knowledge before you commit to building a big, honkin’ platform that will undergird your hundreds of millions of dollars digital transformation. And one way to get that domain knowledge is — say it with me — [agile product development](https://federal-field-notes.ca/articles/2022-03-22-move-fast-stay-safe/#moving-fast-why-releasing-early-and-often-is-important).
